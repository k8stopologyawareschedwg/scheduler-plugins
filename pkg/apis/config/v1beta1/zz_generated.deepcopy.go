...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NumaNodeScorerArgs) DeepCopyInto(out *NumaNodeScorerArgs) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	if in.KubeConfigPath != nil {
		in, out := &in.KubeConfigPath, &out.KubeConfigPath
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NumaNodeScorerArgs.
func (in *NumaNodeScorerArgs) DeepCopy() *NumaNodeScorerArgs {
	if in == nil {
		return nil
	}
	out := new(NumaNodeScorerArgs)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *NumaNodeScorerArgs) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
