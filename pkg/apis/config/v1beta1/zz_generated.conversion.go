...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*NodeResourceTopologyResourceAllocationScoreArgs)(nil), (*config.NodeResourceTopologyResourceAllocationScoreArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_NodeResourceTopologyResourceAllocationScoreArgs_To_config_NodeResourceTopologyResourceAllocationScoreArgs(a.(*NodeResourceTopologyResourceAllocationScoreArgs), b.(*config.NodeResourceTopologyResourceAllocationScoreArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.NodeResourceTopologyResourceAllocationScoreArgs)(nil), (*NodeResourceTopologyResourceAllocationScoreArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_NodeResourceTopologyResourceAllocationScoreArgs_To_v1beta1_NodeResourceTopologyResourceAllocationScoreArgs(a.(*config.NodeResourceTopologyResourceAllocationScoreArgs), b.(*NodeResourceTopologyResourceAllocationScoreArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_NodeResourceTopologyResourceAllocationScoreArgs_To_config_NodeResourceTopologyResourceAllocationScoreArgs(in *NodeResourceTopologyResourceAllocationScoreArgs, out *config.NodeResourceTopologyResourceAllocationScoreArgs, s conversion.Scope) error {
	if err := v1.Convert_Pointer_string_To_string(&in.KubeConfigPath, &out.KubeConfigPath, s); err != nil {
		return err
	}
	if err := v1.Convert_Pointer_string_To_string(&in.MasterOverride, &out.MasterOverride, s); err != nil {
	...
	out.Namespaces = *(*[]string)(unsafe.Pointer(&in.Namespaces))
	if err := v1.Convert_Pointer_string_To_string(&in.ScoreSchedulingStrategy, &out.ScoreSchedulingStrategy, s); err != nil {
		return err
	}
...
// Convert_v1beta1_NodeResourceTopologyResourceAllocationScoreArgs_To_config_NodeResourceTopologyResourceAllocationScoreArgs is an autogenerated conversion function.
func Convert_v1beta1_NodeResourceTopologyResourceAllocationScoreArgs_To_config_NodeResourceTopologyResourceAllocationScoreArgs(in *NodeResourceTopologyResourceAllocationScoreArgs, out *config.NodeResourceTopologyResourceAllocationScoreArgs, s conversion.Scope) error {
	return autoConvert_v1beta1_NodeResourceTopologyResourceAllocationScoreArgs_To_config_NodeResourceTopologyResourceAllocationScoreArgs(in, out, s)
}

func autoConvert_config_NodeResourceTopologyResourceAllocationScoreArgs_To_v1beta1_NodeResourceTopologyResourceAllocationScoreArgs(in *config.NodeResourceTopologyResourceAllocationScoreArgs, out *NodeResourceTopologyResourceAllocationScoreArgs, s conversion.Scope) error {
	if err := v1.Convert_string_To_Pointer_string(&in.KubeConfigPath, &out.KubeConfigPath, s); err != nil {
		return err
	}
	if err := v1.Convert_string_To_Pointer_string(&in.MasterOverride, &out.MasterOverride, s); err != nil {
	...
	out.Namespaces = *(*[]string)(unsafe.Pointer(&in.Namespaces))
	if err := v1.Convert_string_To_Pointer_string(&in.ScoreSchedulingStrategy, &out.ScoreSchedulingStrategy, s); err != nil {
		return err
	}
	out.Resources = *(*[]configv1.ResourceSpec)(unsafe.Pointer(&in.Resources))
	return nil
...
// Convert_config_NodeResourceTopologyResourceAllocationScoreArgs_To_v1beta1_NodeResourceTopologyResourceAllocationScoreArgs is an autogenerated conversion function.
func Convert_config_NodeResourceTopologyResourceAllocationScoreArgs_To_v1beta1_NodeResourceTopologyResourceAllocationScoreArgs(in *config.NodeResourceTopologyResourceAllocationScoreArgs, out *NodeResourceTopologyResourceAllocationScoreArgs, s conversion.Scope) error {
	return autoConvert_config_NodeResourceTopologyResourceAllocationScoreArgs_To_v1beta1_NodeResourceTopologyResourceAllocationScoreArgs(in, out, s)
}
