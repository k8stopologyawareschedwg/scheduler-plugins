...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ResourceAllocationScoreArgs)(nil), (*config.ResourceAllocationScoreArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_ResourceAllocationScoreArgs_To_config_ResourceAllocationScoreArgs(a.(*ResourceAllocationScoreArgs), b.(*config.ResourceAllocationScoreArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.ResourceAllocationScoreArgs)(nil), (*ResourceAllocationScoreArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_ResourceAllocationScoreArgs_To_v1beta1_ResourceAllocationScoreArgs(a.(*config.ResourceAllocationScoreArgs), b.(*ResourceAllocationScoreArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_ResourceAllocationScoreArgs_To_config_ResourceAllocationScoreArgs(in *ResourceAllocationScoreArgs, out *config.ResourceAllocationScoreArgs, s conversion.Scope) error {
	if err := v1.Convert_Pointer_string_To_string(&in.KubeConfigPath, &out.KubeConfigPath, s); err != nil {
		return err
	}
	if err := v1.Convert_Pointer_string_To_string(&in.MasterOverride, &out.MasterOverride, s); err != nil {
...
// Convert_v1beta1_ResourceAllocationScoreArgs_To_config_ResourceAllocationScoreArgs is an autogenerated conversion function.
func Convert_v1beta1_ResourceAllocationScoreArgs_To_config_ResourceAllocationScoreArgs(in *ResourceAllocationScoreArgs, out *config.ResourceAllocationScoreArgs, s conversion.Scope) error {
	return autoConvert_v1beta1_ResourceAllocationScoreArgs_To_config_ResourceAllocationScoreArgs(in, out, s)
}

func autoConvert_config_ResourceAllocationScoreArgs_To_v1beta1_ResourceAllocationScoreArgs(in *config.ResourceAllocationScoreArgs, out *ResourceAllocationScoreArgs, s conversion.Scope) error {
	if err := v1.Convert_string_To_Pointer_string(&in.KubeConfigPath, &out.KubeConfigPath, s); err != nil {
		return err
	}
	if err := v1.Convert_string_To_Pointer_string(&in.MasterOverride, &out.MasterOverride, s); err != nil {
...
// Convert_config_ResourceAllocationScoreArgs_To_v1beta1_ResourceAllocationScoreArgs is an autogenerated conversion function.
func Convert_config_ResourceAllocationScoreArgs_To_v1beta1_ResourceAllocationScoreArgs(in *config.ResourceAllocationScoreArgs, out *ResourceAllocationScoreArgs, s conversion.Scope) error {
	return autoConvert_config_ResourceAllocationScoreArgs_To_v1beta1_ResourceAllocationScoreArgs(in, out, s)
}
