...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*NumaNodeScorerArgs)(nil), (*config.NumaNodeScorerArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1beta1_NumaNodeScorerArgs_To_config_NumaNodeScorerArgs(a.(*NumaNodeScorerArgs), b.(*config.NumaNodeScorerArgs), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.NumaNodeScorerArgs)(nil), (*NumaNodeScorerArgs)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_NumaNodeScorerArgs_To_v1beta1_NumaNodeScorerArgs(a.(*config.NumaNodeScorerArgs), b.(*NumaNodeScorerArgs), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1beta1_NumaNodeScorerArgs_To_config_NumaNodeScorerArgs(in *NumaNodeScorerArgs, out *config.NumaNodeScorerArgs, s conversion.Scope) error {
	if err := v1.Convert_Pointer_string_To_string(&in.KubeConfigPath, &out.KubeConfigPath, s); err != nil {
		return err
	}
	if err := v1.Convert_Pointer_string_To_string(&in.MasterOverride, &out.MasterOverride, s); err != nil {
...
// Convert_v1beta1_NumaNodeScorerArgs_To_config_NumaNodeScorerArgs is an autogenerated conversion function.
func Convert_v1beta1_NumaNodeScorerArgs_To_config_NumaNodeScorerArgs(in *NumaNodeScorerArgs, out *config.NumaNodeScorerArgs, s conversion.Scope) error {
	return autoConvert_v1beta1_NumaNodeScorerArgs_To_config_NumaNodeScorerArgs(in, out, s)
}

func autoConvert_config_NumaNodeScorerArgs_To_v1beta1_NumaNodeScorerArgs(in *config.NumaNodeScorerArgs, out *NumaNodeScorerArgs, s conversion.Scope) error {
	if err := v1.Convert_string_To_Pointer_string(&in.KubeConfigPath, &out.KubeConfigPath, s); err != nil {
		return err
	}
	if err := v1.Convert_string_To_Pointer_string(&in.MasterOverride, &out.MasterOverride, s); err != nil {
...
// Convert_config_NumaNodeScorerArgs_To_v1beta1_NumaNodeScorerArgs is an autogenerated conversion function.
func Convert_config_NumaNodeScorerArgs_To_v1beta1_NumaNodeScorerArgs(in *config.NumaNodeScorerArgs, out *NumaNodeScorerArgs, s conversion.Scope) error {
	return autoConvert_config_NumaNodeScorerArgs_To_v1beta1_NumaNodeScorerArgs(in, out, s)
}
